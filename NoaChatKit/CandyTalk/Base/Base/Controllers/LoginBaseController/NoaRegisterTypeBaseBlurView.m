...
@interface NoaRegisterTypeBaseBlurView ()
...
@implementation NoaRegisterTypeBaseBlurView
...
- (void)updateGradientForCurrentTheme {
    ...
    if (isDarkMode) {
        ...
        // 浅色模式渐变：linear-gradient(180deg, rgba(255, 255, 255, 0.4) 0%, #FFFFFF 46.73%, #FFFFFF 91.67%)
        // 严格按照设计稿的颜色值
        NSArray *colors = @[
            (id)[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:0.4].CGColor,  // rgba(255, 255, 255, 0.4) 0%
            (id)[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:1.0].CGColor,  // #FFFFFF 46.73%
            (id)[UIColor colorWithRed:1.0 green:1.0 blue:1.0 alpha:1.0].CGColor   // #FFFFFF 91.67%
        ];
        
        self.gradientLayer.colors = colors;
        self.gradientLayer.locations = @[@0.0, @0.4673, @0.9167];
        // 提高渐变层透明度，保持设计图的颜色明显
