//
//  LuckyLandChatRecordDetailViewController.m
//  NoaKit
//
//  Created by LuckyLand on 2023/4/25.
//

#import "LuckyLandChatRecordDetailViewController.h"
...
@interface LuckyLandChatRecordDetailViewController () <UITableViewDelegate, UITableViewDataSource, ZMessageBaseCellDelegate, KNPhotoBrowserDelegate>

@property (nonatomic, strong) NSMutableArray *recordMsgList;

@end

@implementation LuckyLandChatRecordDetailViewController
