...
#import "LuckyLandGroupMyNicknameVC.h"//我在本群的昵称VC
...
@interface LuckyLandChatGroupSetVC () <UITableViewDataSource,UITableViewDelegate,ZBaseCellDelegate,CIMToolGroupDelegate>
...
@implementation LuckyLandChatGroupSetVC
...
- (void)myGroupNicknameChange {
    if (self.groupInfoModel) {
        WeakSelf
        LuckyLandGroupMyNicknameVC *vc = [LuckyLandGroupMyNicknameVC new];
        vc.groupInfoModel = self.groupInfoModel;
...
- (void)deleteAllChatMessage {
    if (![NSString isNil:_groupID]) {
        ...
        viewTip.btnCancel.tkThemebackgroundColors = @[COLOR_1B2E60, COLOR_1B2E60];
...
- (void)quiteGroup{
    if (![NSString isNil:_groupID]) {
        ...
        if (self.groupInfoModel.userGroupRole == 2) {
            ...
            viewTip.btnSure.tkThemebackgroundColors = @[COLOR_1B2E60, COLOR_1B2E60];
