//
//  LuckyLandGroupTopMessageListViewController.m
//  NoaChatKit
//
...
@interface LuckyLandGroupTopMessageListViewController () <UITableViewDelegate, UITableViewDataSource, ZMessageBaseCellDelegate>

@property (nonatomic, strong) NSMutableArray<NoaMessageModel *> *messageList;

@end

@implementation LuckyLandGroupTopMessageListViewController
...
- (void)showCancelGlobalTopAlertWithMsgModel:(NoaMessageModel *)msgModel {
    ...
    alertView.btnSure.tkThemebackgroundColors = @[COLOR_1B2E60, COLOR_1B2E60_DARK];
