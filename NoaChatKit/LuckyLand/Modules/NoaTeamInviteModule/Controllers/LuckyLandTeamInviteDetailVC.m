...
@implementation LuckyLandTeamInviteDetailVC
...
- (void)processData {
    ...
    [self.teamDetailView.editTeamNameSubject subscribeNext:^(id  _Nullable x) {
        @strongify(self)
        LuckyLandTeamInviteEditTeamNameVC *editTeamNameVC = [LuckyLandTeamInviteEditTeamNameVC new];
