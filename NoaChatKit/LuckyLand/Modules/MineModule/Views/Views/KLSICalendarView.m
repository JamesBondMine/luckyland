...
- (void)createCalendarViewWith:(NSDate *)date{
    ...
    // 周
    NSArray *array = @[LanguageToolMatch(@"星期日"), LanguageToolMatch(@"星期一"), LanguageToolMatch(@"星期二"), LanguageToolMatch(@"星期三"), LanguageToolMatch(@"星期四"), LanguageToolMatch(@"星期五"), LanguageToolMatch(@"星期六")];
    UIView *weekBg = [[UIView alloc] init];
    weekBg.tkThemebackgroundColors = @[COLORWHITE, COLOR_11];
...
{
    btn.enabled = NO;
    [btn setTkThemeTitleColor:@[COLORWHITE, COLOR_11] forState:UIControlStateNormal];
}
