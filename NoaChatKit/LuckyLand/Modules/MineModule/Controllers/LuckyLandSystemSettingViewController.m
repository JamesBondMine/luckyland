//
//  LuckyLandSystemSettingViewController.m
//  NoaKit
//
...
@interface LuckyLandSystemSettingViewController () <UITableViewDelegate, UITableViewDataSource, ZBaseCellDelegate>
...
@implementation LuckyLandSystemSettingViewController
...
- (void)accountLogoutAction {
    ...
    WeakSelf
    msgAlertView.sureBtnBlock = ^(BOOL isCheckBox) {
        LuckyLandAccountRemoveViewController *accountRemove = [[LuckyLandAccountRemoveViewController alloc] init];
