//
//  LuckyLandSignRecordsViewController.m
//  NoaKit
//
//  Created by Apple on 2023/8/9.
//

#import "LuckyLandSignRecordsViewController.h"
#import "NoaSignRecordsTableViewCell.h"
#import "NoaFDatePickerView.h"
#import <DZNEmptyDataSet/UIScrollView+EmptyDataSet.h>

@interface LuckyLandSignRecordsViewController ()<UITableViewDelegate,UITableViewDataSource,DZNEmptyDataSetSource,DZNEmptyDataSetDelegate>
@property (nonatomic, strong)NSArray *dataArr;
@property (nonatomic,strong) UIButton * downButtonMenu;
@property(nonatomic,strong) UILabel * getTotlePointLabel;
@end

@implementation LuckyLandSignRecordsViewController
