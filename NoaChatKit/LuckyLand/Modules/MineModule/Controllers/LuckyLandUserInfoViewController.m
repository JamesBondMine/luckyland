//
//  LuckyLandUserInfoViewController.m
//  NoaKit
//
...
#import "LuckyLandChangeUserInfoViewController.h"
...
@interface LuckyLandUserInfoViewController () <UITableViewDelegate, UITableViewDataSource, ZImagePickerVCDelegate, ZBaseCellDelegate, ZMineUserInfoCellDelegate>
...
@implementation LuckyLandUserInfoViewController
...
- (void)cellClickAction:(NSIndexPath *)indexPath {
    switch (indexPath.row) {
        ...
        {
            //修改昵称
            LuckyLandChangeUserInfoViewController *nickChangeVC = [[LuckyLandChangeUserInfoViewController alloc] init];
        ...
        case 2:
        {
            ...
            /*
            //修改账号
            LuckyLandChangeUserInfoViewController *accountChangeVC = [[LuckyLandChangeUserInfoViewController alloc] init];
