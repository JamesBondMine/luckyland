//
//  LuckyLandCharacterRegisterViewController.m
//  NoaKit
//
...
@interface LuckyLandCharacterRegisterViewController ()
...
@implementation LuckyLandCharacterRegisterViewController
    ...
    [IMSDKManager imSdkTranslateRegisterBindAccount:dict onSuccess:^(id _Nullable data, NSString * _Nullable traceId) {
        ...
        if (weakSelf.isFromBind) {
            for (UIViewController * vc in weakSelf.navigationController.viewControllers) {
                if([vc isKindOfClass:[LuckyLandCharacterManagerViewController class]]){
                    LuckyLandCharacterManagerViewController *managerVC = (LuckyLandCharacterManagerViewController *)vc;
