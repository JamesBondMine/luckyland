//
//  LuckyLandSafeCodeCloseViewController.m
//  NoaKit
//
...
@interface LuckyLandSafeCodeCloseViewController ()
...
@implementation LuckyLandSafeCodeCloseViewController
    ...
    [IMSDKManager authCloseSecurityCodeWith:params onSuccess:^(id  _Nullable data, NSString * _Nullable traceId) {
        ...
        if (result) {
            ...
            for (UIViewController *vc in viewControllers) {
                if ([vc isKindOfClass:[LuckyLandSafeSettingViewController class]]) {
                    LuckyLandSafeSettingViewController *safeCodeSettingVC = (LuckyLandSafeSettingViewController *)vc;
        ...
        if (code == Auth_Original_Security_Code_Error_Code) {
            ...
            if (self.securityCodeFailNum < SECURITY_CODE_FAIL_MAX_NUM) {
                ...
                LuckyLandSafeCodeCloseViewController *vc = [[LuckyLandSafeCodeCloseViewController alloc] init];
