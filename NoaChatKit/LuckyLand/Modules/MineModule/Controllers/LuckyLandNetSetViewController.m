//
//  LuckyLandNetSetViewController.m
//  NoaKit
//
...
@interface LuckyLandNetSetViewController ()<UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, assign) ProxyType currentType;
@end

@implementation LuckyLandNetSetViewController
...
- (void)setUpNavUI {
    ...
    self.navBtnRight.tkThemebackgroundColors = @[COLOR_1B2E60, COLOR_1B2E60];
