//
//  LuckyLandNewMassMessageVC.m
//  NoaKit
//
//  Created by LuckyLand on 2023/4/17.
//

#import "LuckyLandNewMassMessageVC.h"
...
@interface LuckyLandNewMassMessageVC () <UICollectionViewDataSource, UICollectionViewDelegate, ZMassMessageSelectUserDelegate, ZNewMassMessageContentViewDelegate>
...
@implementation LuckyLandNewMassMessageVC
...
- (void)goSelectReceiveMessageUser {
    ...
    LuckyLandMassMessageSelectUserVC *vc = [LuckyLandMassMessageSelectUserVC new];
